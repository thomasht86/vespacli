...
class VespaCLIInstaller:
    ...
    def update_shell_profile(self, installation_path):
        """Append the installation path to the PATH environment variable in the user's shell profile for Darwin/Linux."""
        ...
        if 'zsh' in shell:
            ...
            logging.warning("Unsupported shell for automatic PATH update.")
            return
