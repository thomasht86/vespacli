...
public class ModelsTest {
    ...
    public void testModels() throws ParseException {
        ...
        // The "models" directory contains 2 ONNX models: "transformer" and
        // "pairwise_ranker"
    ...
    private void testTransformerModel(ModelsEvaluator modelsEvaluator) throws ParseException {
        ...
        // The transformer model has one input, named "input" and has type
        // "tensor(d0[],d1[])"
    ...
    private void testPairwiseRanker(ModelsEvaluator modelsEvaluator) {
        ...
        // Test the model
        Tensor query = Tensor.from(
                "tensor<float>(d0[1],d1[16]):[0.11,0.94,0.04,0.86,0.75,0.88,0.73,0.21,0.67,0.68,0.82,0.93,0.88,0.66,0.66,0.91]");
        Tensor doc1 = Tensor.from(
                "tensor<float>(d0[1],d1[16]):[0.02,0.98,0.31,0.28,0.44,0.17,0.18,0.62,0.78,0.57,0.89,0.39,0.69,0.16,0.70,0.79]");
        Tensor doc2 = Tensor.from(
                "tensor<float>(d0[1],d1[16]):[0.32,0.33,0.02,0.90,0.85,0.93,0.89,0.12,0.06,0.08,0.26,0.62,0.40,0.94,0.64,0.23]");
